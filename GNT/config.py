...
def config_parser():
    ...
    parser.add_argument("--n_heads", type=int, default=4, help="network intermediate dimension")
    parser.add_argument(
        "--sigmoid", action="store_true", help="whether use sigmoid for rgb value after the last fc layer"
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[],
        help="specify the camera type, choose from road | security | drone",
    )
