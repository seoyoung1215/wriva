...
class RealEstateDataset(Dataset):
    def __init__(self, args, mode, **kwargs):
        ...
        print("RealEstateDataset",len(self.scene_path_list))
        all_rgb_files = []
        all_timestamps = []
        ...
        # print(all_rgb_files[0])
        self.all_rgb_files = all_rgb_files #np.array(all_rgb_files)[index]
        self.all_timestamps = all_timestamps #np.array(all_timestamps)[index]
