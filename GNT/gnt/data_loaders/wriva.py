...
class WRIVADataset(Dataset):
    def __init__(
        ...
        **kwargs
        ...
        except_scenes = ["camA501-road-001/2023-03-14-11-36-34"]
        ...
        if self.camera==[]:
            ...
            for cam in self.camera:
                if cam=="road":
                    all_dirs.append("camA501-road-001")
                elif cam=="drone":
                    all_dirs.append("camA503-drone-001")
                else:
                    all_dirs.append("camA502-security-001")
